  ...
  <div class="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" @click.self="emit('close')">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md">
      <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
        <div>
          <h2 class="text-xl font-bold text-gray-900">Nuevo Cliente</h2>
          <p class="text-xs text-gray-400">Contacto/historial — sin acceso a la web todavía</p>
        </div>
      ...
      <div class="p-6 space-y-5">
        ...
        <p class="text-xs text-gray-400">
          Si más adelante quiere comprar online, puede activar su cuenta él mismo desde la tienda usando este correo.
        </p>
      ...
      <div class="px-6 py-4 border-t border-gray-100 flex justify-end gap-3">
        ...
        >
          <i class="fa-solid fa-save"></i> {{ isSaving ? 'Guardando...' : 'Registrar Cliente' }}
        </button>
      </div>
    </div>
  </div>
