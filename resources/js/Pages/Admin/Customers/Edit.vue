        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="flex gap-4">
            <button
              type="submit"
              :disabled="loading"
              class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed font-semibold uppercase tracking-wide"
            >
